...
data <- read.csv(
    "./results/mouse/all_cell_lines/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/feature_importance.csv",
    header = TRUE,
    row.names = 1
)

features <- read.csv(
    "./graphing/mouse/D/features-LL_P5_P3_CF_AAF_3mer_freq_5.csv",
    header = TRUE
)
...
ggsave(
    ...
    filename = "./graphing/mouse/D/graph_feature_importance.pdf",
    plot = p,
    width = 3,
    height = 5,
    units = "in"
